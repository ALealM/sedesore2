...
use App\Models\FuncIngresos;
use App\Models\InversionMunicipio;
?>
...
<script type="text/javascript">
    ...
    <?php
$inversionTotal = 0;
$inversion = InversionMunicipio::where('id_municipio', $mun_id)->get();
$valoresFr = '';
foreach ($inversion as $inv) {
    $valoresFr .= "{name:'" . $inv->programa . "',data:[" . $inv->monto . "]},";
    $inversionTotal += $inv->monto;
}
?>
 
        Highcharts.chart('inversion_municipio', {
    chart: {
    type: 'column',
            options3d: {
            enabled: false,
            ...
            title: {
            text: 'Inversión por programa'
            },
            subtitle: {
            text: 'Total <?php echo (number_format($inversionTotal)) ?> inversion'
            },
            xAxis: {
            categories: [
                    'Programas',
...
<?php } ?>
    ...
    type: 'column',
            ...
            title: {
            text: '<b>PARTIDOS</b><br><b>Totales de personas pertenecientes a cada partido</b>',
                    style: {'color': '#333'}
            },
            xAxis: {
            categories: [
    ...
    events: {
                        click: function (event) {
                            partidosListado(this.name,<?php echo $mun_id;?>);
                        }
                    },
                    borderWidth: 0
            },
...
?>
    ...
    plotBackgroundColor: null,
            ...
            colors: ['#03A678', '#555', '#ABB7B7', '#C0392B', '#68C3A3'],
            title: {
            text: '<b>Empleados por partido político<br></b><b>Total <?php echo (number_format($sumEmpTot)) ?> personas</b>',
                    style: {'color': '#333'}
            },
            tooltip: {
            style: {'color': '#333'}
...
$totMas20 = 0;
$totMenos20 = 0;
//$mas20Per = FuncIngresos::select('partido',\DB::raw('count(id) as total'))->where('sueldo','>',20000)->where('partido','>',0)->groupBy('partido')->get();
$mas20 = FuncIngresos::select('partido',\DB::raw('count(id) as total'))->where('sueldo','>',20000)->where('partido','>',0)->groupBy('partido')->get();
//$menos20Per = FuncIngresos::select('partido',\DB::raw('count(id) as total'))->where('sueldo','<',20000)->where('partido','>',0)->groupBy('partido')->get();
$menos20 = FuncIngresos::select('partido',\DB::raw('count(id) as total'))->where('sueldo','<',20000)->where('partido','>',0)->groupBy('partido')->get();
foreach($menos20 as $menos_20){
//    dd($mas_20->partido());
    $vMenos20.="{name: '".$menos_20->partido()->partido."',data:[$menos_20->total]},";
    $colMenos20.=$menos_20->partido()->color.",";
    $totMenos20 += $menos_20->total;
}
foreach($mas20 as $mas_20){
//    dd($mas_20->partido());
    $vMas20.="{name: '".$mas_20->partido()->partido."',data:[$mas_20->total]},";
    $colMas20.=$mas_20->partido()->color.",";
    $totMas20 += $mas_20->total;
}

?>
<script type="text/javascript">
$(function () {
    Highcharts.chart('mas20', {
    chart: {
    type: 'column',
            options3d: {
            enabled: true,
            ...
            colors: [<?php echo $colMas20; ?>],
            title: {
            text: '<b>Totales de afiliados con sueldo mayor a $20,000</b><br><b><?php echo $totMas20; ?> personas</b>',
                    style: {'color': '#333'}
            },
            xAxis: {
            categories: [
            ...
            series: [<?php echo $vMas20; ?>]
    });
    Highcharts.chart('menos20', {
    chart: {
    type: 'column',
            options3d: {
            enabled: true,
            ...
            colors: [<?php echo $colMenos20; ?>],
            title: {
            text: '<b>Totales de afiliados con sueldo menor a $20,000</b><br><b><?php echo $totMenos20; ?> personas</b>',
                    style: {'color': '#333'}
            },
            xAxis: {
            categories: [
            ...
            series: [<?php echo $vMenos20; ?>]
    });
});


<?php
use App\Models\SegmentacionPadron;

$poblacion = SegmentacionPadron::where('id_municipio', $id_mun)->get();
$pobMaxH = SegmentacionPadron::where('id_municipio', $id_mun)->max('hombres');
$pobMaxM = SegmentacionPadron::where('id_municipio', $id_mun)->max('mujeres');
if ($pobMaxH > $pobMaxM)
    $pobMax = $pobMaxH;
else
    $pobMax = $pobMaxM;
...
$(function () {
        ...
        $(document).ready(function () {
            $('#grafica123').highcharts({
                chart: {
                    type: 'column',
                    inverted: false
                },
                colors: ['#03A678', '#555', '#ABB7B7'],
                title: {
                    text: 'Padrón por género y rango de edades'
                },
                subtitle: {
                    text: 'Población total: <?php echo number_format($totPob); ?>'
                },
                xAxis: [{
        ...
        <div class="row ng-scope">
            <div class="col-md-12">
                <div class="clearfix">
                                ...
                                <div class="col-lg-6">
                                    <section class="widget" style="background-color: #313131; color:white; text-align: center; margin: auto;">
                                        ...
                                        <div class="col-lg-5 col-md-5">
                                            ...
                                            <img src="<?php echo e(url(asset('img/inversion.png'))); ?>" style="width: auto; height: 700px;">
                                        </div>
                                    </section>
                                </div>
                                <div class="col-lg-6 ">
                    ...
                    <div class="row ng-scope">
                        <div class="mt col-lg-11 col-md-11">
                            <div>
                    ...
                    <hr class="col-lg-11 col-md-11 " style="border-top: 1px dashed #8c8b8b;">
                    ...
                    <div class="row ng-scope">
                        <div class="mt col-lg-11 col-md-11">
                            <div>
                                <section class="widget" style="background: none;">
                                    <header>
                                        <h4>INVERSIÓN DE PROGRAMAS POR MUNICIPIO:</h4>
                                        <hr class="col-md-12">
                                    </header>
                                    <div style="width:100%; display: inline-block;">
                                        <div>
                                            <div id="inversion_municipio" ></div>
                                        </div>
                                    </div>
                                </section>
                            </div>     
...
<!--                                    <header>
                                    ...
                                    <div style="width:100%; display: inline-block;">
                                        <div>
                                            <div id="grafica123" style="height: 400px;"></div>
                                        </div>
                                    </div>
                                </section>
                            </div>          
                        ...
                        <div class="row ng-scope" style="background-color: #eeeeee; color:black;">
                            <div class="col-lg-10 col-md-10 ">
                                <section class="widget" style="background: none;">
                                    ...
                                    <div style="width:100%; display: inline-block;">
                                        <div>
                                            <div id="empleados_estatales" style="height: 400px;"></div>
                                        </div>
                                    </div>
                                </section>
                            </div>          
                    ...
                    <div class="row ng-scope">
                        ...
                        <hr class="col-lg-11 col-md-11" style="border-top: 1px dotted #8c8b8b;">
                        ...
                        <section class="widget" style="background: none;">
                            ...
                            <div class="row ng-scope">
                                <div class="mt col-lg-10 col-md-10">
                                    ...
                                    <hr class="col-lg-10 col-md-10" style="border-top: 1px dotted #8c8b8b; margin: 5%;">
                    ...
                    <div class="row ng-scope">
                        ...
                        <div class="row ng-scope" style="background-color: #eeeeee; color:black;">
                            ...
                            <div class="col-lg-10 col-md-10 ">
                                <section class="widget" style="background: none;">
                                    <header onclick="resultados('')">
                                        <h4><a href="<?php echo e(url('/resultados/partPolOp/'.$mun_id)); ?>">EMPLEADOS EN PARTIDOS POLÍTICOS</a></h4>
                                        <hr class="col-md-10">
                                    </header>
                                    <div style="width:100%; display: inline-block;">
                                        <div>
                    ...
                    <div class="row ng-scope">
                        <div class="mt col-lg-10 col-md-10">
                            <section class="widget" style="background: none;">
                                <header>
                                    <h4>TOTAL DE MILITANTES EN PARTIDOS POLITICOS DE OPOSICION 2016:</h4>
                                </header>
