...
<nav id="sidebar" class="sidebar" role="navigation">
    ...
    <div class="js-sidebar-content">
        <header class="logo hidden-sm-down">
            <a href="index.html">Sistema Análisis</a>
        </header>
                ...
                <section class="widget bg-transparent">
                    ...
                    <div class="widget-body">
                        <div id="map" class="mapael">
                            <div class="stats">
                                <h6 class="text-gray m-t-1">Población total</h6>
                                <p class="h3 text-warning no-margin"><strong id="geo-locations-number">2 785 718 hab</strong> <i class="fa fa-group"></i></p>
                            </div>
                            <div class="map">
                ...
                <div class="mt col-lg-12 col-md-12">
                    <table id="datatable-table" class="table table-striped table-hover dataTable no-footer" role="grid" aria-describedby="datatable-table_info">
                        ...
                        <tr>
                            <th>Id</th>
                            <th>Nombre</th>
                            <th class="hidden-sm-down">RFC</th>
                            <th>Domicilio</th>
                            <th>Localidad</th>
                            <th>Municipio</th>
                        ...
                        <tr>
                            ...
                            <td><span class="fw-semi-bold"><?php echo $reporte->nombre(); ?></span></td>
                            <td class="hidden-sm-down">
                                <small>
                                    <span class="fw-semi-bold"><?php echo $reporte->rfc; ?></span>
                                </small>
                            </td>
                            <td><?php echo $reporte->domicilio(); ?></td>
                            <td><?php echo $reporte->localidad; ?></td>
                            <td><?php echo $reporte->municipio; ?></td>
                            <td><?php echo date("d/m/Y", strtotime($reporte->fecha_nacimiento)); ?></td>
                        </tr>
...
<script src="vendor/jQuery-Mapael/js/maps/san_luis_potosi.js"></script>
