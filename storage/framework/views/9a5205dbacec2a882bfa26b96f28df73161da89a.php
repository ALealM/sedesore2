...
<script type="text/javascript">
    ...
    <?php foreach($programas as $prog){ ?>
        ...
        Highcharts.chart('partidos', {
            ...
            colors: ['#1f4187', '#e0ac00', '#49a03e', '#14959b', '#ce7a37','#682d7a'],
            title: {
                text: '<b>PARTIDOS</b>',
                style: {'color': '#333'}
            },
        ...
        while($prgPrt<=6){
            ...
            $valores='';
            $colores='';
            $color= ['#1f4187', '#e0ac00', '#49a03e', '#14959b', '#ce7a37','#682d7a'];
            $i=0;
...
$(function () {
    ...
    <?php
        ...
        foreach($numBen as $numB){ 
            $valoresFr.= "['".$numB->cantidad." programas',".$numB->total."],";
        ...
        Highcharts.chart('promovidosProgramas', {
            ...
            colors: ['#03A678', '#555', '#ABB7B7', '#C0392B', '#68C3A3'],
            title: {
                text: '<b style="color:black">PERSONAS PROMOVIDAS POR PROGRAMA</b>'
            },
            subtitle: {
...
Highcharts.chart('beneficiarios', {
    ...
    series: [{
        name: 'Total',
        data: [
            ['BENEFICIARIOS', <?php echo $conBen ?>],
            ['SIN BENEFICIO', <?php echo $sinBen->total ?>]
        ]
    }]
});
...
Highcharts.chart('sindicatosTotal', {
            ...
            subtitle: {
                text: 'Totales de personas pertenecientes a sindicatos'
            },
            xAxis: {
                categories: [
                    'Sindicatos',
        ...
        Highcharts.chart('representantesDiferencia', {
            ...
            subtitle: {
                text: 'Total: 10,083 representantes'
            },
            tooltip: {
                style: {'color': '#333'}
            },
    ...
    <div class="row ng-scope">
        ...
        <div class="row ng-scope">
                        ...
                        <div class="col-lg-6">
                            <section class="widget" style="background-color: #313131; color:white; text-align: center; margin: auto;">
                                ...
                                <div class="col-lg-5 col-md-5">
                                    ...
                                    <img src="<?php echo e(url(asset('img/inversion.png'))); ?>" style="width: auto; height: 300px;">
                                </div>
                            </section>
                        </div>
                        <div class="col-lg-6 ">
            ...
            <div class="col-lg-4 col-md-4 ">
                    <section class="widget" style="background: none;">
                        <header>
                            <h4>ESTRUCTURA DE PROMOCIÓN: 60,550 individuos</h4>
                            <hr class="col-md-10">
                        </header>
                        <div style="width:100%; display: inline-block;">
                            <div>
                                <!--<div id="chart-container">FusionCharts will render here</div>-->
                                <img src="<?php echo e(url(asset('img/estructura_electoral.png'))); ?>">
                            </div>
                        </div>
                    </section>
                </div>      
