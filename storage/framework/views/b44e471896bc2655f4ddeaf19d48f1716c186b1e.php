        ...
        <section>
            <div class="widget-body">
                <div class="form-group "> 
                    <div class="pagAjax table-responsive" id="pagAjax_form"data-url="<?php echo e(url('personas/auditoria')); ?>">
                        <?php echo $__env->make('principal.tableAuditoriaShow', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('principal.datosAuditoriaShow', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
