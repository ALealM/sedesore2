                        ...
                        <div class="widget-body">
                            <div class="stats-row">
                                <div class="stat-item">
                                    ...
                                    <p class="value"><?php echo $total_beneficiarios[$i]?></p>
                                </div>
                            </div>
            ...
            <section class="widget">
                ...
                <div class="mt col-lg-12 col-md-12">
                    <table id="datatable-table" class="table table-striped table-hover dataTable no-footer" role="grid" aria-describedby="datatable-table_info">
                        ...
                        <tr>
                            <td><a onclick="datos(<?php echo e($beneficiario->id); ?>)" style="cursor:pointer;"><?php echo $beneficiario->nombre(); ?></a></td>
                            <?php $__currentLoopData = $beneficiario->programas(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
