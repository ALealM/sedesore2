...
$(function () {    
    ...
    <?php 
        ...
        Highcharts.chart('promotoresProgramas', {
            ...
            colors: ['#03A678', '#555', '#ABB7B7', '#C0392B', '#68C3A3'],
            title: {
                text: '<b style="color:black">PROMOTORES POR PROGRAMA</b>'
            },
            subtitle: {
                text: 'Total <?php echo (number_format($sumPromTot)) ?> personas con programa'
            },
    ...
    <div class="row ng-scope">
          ...
          <div class="col-lg-12 col-md-12 ">    
                    <section class="widget col-lg-offset-2 col-lg-8 col-md-8" style="background: none;">
                        <header>
                            <h4>ESTRUCTURA DE PROMOCIÓN: 550,000(Meta)</h4>
                            <hr class="col-md-10">
                        </header>
                        <div class="col-lg-9 col-md-9 ">
                            
                            <img class="col-lg-12 col-md-12 " src="<?php echo e(url(asset('img/estructura_de_promocion.png'))); ?>">
                            
                        </div>
                        <div class="col-lg-3 col-md-3 " style="vertical-align: middle; top:50%;"><br><br><br><br><br><br><br><br><p><b>Actualmente se validan 16,000 registros de la primera quincena de Julio</b></p></div>
                    </section>
                </div>
                    ...
                    <div>
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                <div>
                                    <div id="promovidosProgramas" style="max-height: 600px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt col-lg-10 col-md-10">
                    <div>
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                <div>
                                    <div id="promovidosPartidos" style="max-height: 600px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt col-lg-10 col-md-10">
                    <div>
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                <div>
                                    <div id="promotoresProgramas" style="max-height: 600px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
