                ...
                <div class="col-md-8">
                    <section class="widget bg-transparent">
                        ...
                        <div class="widget-body">
                            ...
                            $color = ['progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger'];?>
                            <?php 
                            if($programa->total_general==0){
                            $porProg =  0;
                            }else{
                            $porProg = ($programa->total/$programa->total_general)*100;
                            }
                ...
                <section class="widget">
                    ...
                    <div class="row ng-scope">
                        ...
                        <?php $__currentLoopData = $programas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $programa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php 
                            /*$color = ['#006633','#C0392B','#03A678','#555','#ABB7B7','#006633','#C0392B','#03A678','#555','#ABB7B7'];*/
                            $color = ['progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger','progress-bar-info','progress-bar-success', 'progress-bar-danger'];?>
                            <?php 
                            if($programa->total_general==0){
                            $porProg =  0;
                            }else{
