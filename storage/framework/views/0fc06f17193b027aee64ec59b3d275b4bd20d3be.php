...
<!--                    <a class="hidden-md-down nav-link" id="nav-state-toggle" href="#" data-toggle="tooltip" data-html="true" data-original-title="Turn<br>on/off<br>sidebar<br>collapsing" data-placement="bottom">
                ...
                <li class="nav-item hidden-sm-down"><a href="<?php echo e(url('/logout')); ?>"
                ...
                <li class="nav-item hidden-md-up"><a href="<?php echo e(url('/index')); ?>">
                        <span><i class="fa fa-home fa-lg"></i></span>
                    </a>
                </li>
                <li class="nav-item hidden-md-up"><a href="<?php echo e(url('/busqueda')); ?>">
                        <span><i class="fa fa-search fa-lg"></i></span>
                    </a>
                </li>
                <li class="nav-item hidden-md-up"><a href="<?php echo e(url('/personas/listado')); ?>">
                        <span><i class="fa fa-list-alt fa-lg"></i></span>
                    </a>
                </li>
                <li class="nav-item hidden-md-up"><a href="<?php echo e(url('/personas/auditoria')); ?>">
                        <span><i class="fa fa-check-square-o fa-lg"></i></span>
                    </a>
                </li>
                <li class="nav-item hidden-md-up"><a href="<?php echo e(url('/personas/auditoriaVer')); ?>">
                        <span><i class="fa fa-eye fa-lg"></i></span>
                    </a>
                </li>
                <li class="nav-item hidden-md-up"><a href="<?php echo e(url('/logout')); ?>"
                                                       onclick="event.preventDefault();
                                                               document.getElementById('logout-form').submit();">
