...
<hr class="col-lg-10 col-md-10" style="border-top: 1px dashed #8c8b8b;">  
      ...
      <div class="row ng-scope col-lg-12 col-md-12">
            ...
            <section class="widget">
                <div class="row table-responsive">
                    <table class="table dataTable no-footer table-striped" role="grid" aria-describedby="example1_info">
                        ...
                        <tbody>
                            <tr><td>San Luis Potosí</td></tr>
                            <tr><td>Soledad de Graciano Sánchez</td></tr>
                            <tr><td>Zaragoza</td></tr>
                            <tr><td>Villa de Reyes</td></tr>
                            <tr><td>Cerro de San Pedro</td></tr>
                            <tr><td>Mexquitic de Carmona</td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
