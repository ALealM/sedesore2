...
<nav id="sidebar" class="sidebar" role="navigation">
    ...
    <div class="js-sidebar-content">
        ...
        <ul class="sidebar-nav scroll" style="font-size: 14px; line-height: 15px;">
            <li class="active">
                <a href="#sidebar-dashboard" data-toggle="collapse" data-parent="#sidebar">
                    ...
                    <span class="icon">
                        ...
                        Padron de<br> beneficiarios</a>
                </a>
            </li>
            
            <li style="margin: 0 2px;">
                <a href="#sidebar-dashboard" data-toggle="collapse" data-parent="#sidebar">
                    <a href="<?php echo e(url('totales/0')); ?>">
            ...
            <li style="margin: 0 2px;">
                <a href="#sidebar-dashboard" data-toggle="collapse" data-parent="#sidebar">
                    <a href="<?php echo e(url('casillas/1/0')); ?>">
                    <span class="icon"><i class="fa fa-list-alt"></i></span>
                    <span>Mesa 3</span></a>
                </a>
            </li>
            ...
            <!--<li style="margin: 0 2px;">
                <a href="#sidebar-dashboard" data-toggle="collapse" data-parent="#sidebar">
                    ...
                    <span>Resultados Totales</span></a>
                </a>
            </li>-->
            <li style="margin: 0 2px;">
                <a href="#sidebar-dashboard" data-toggle="collapse" data-parent="#sidebar">
                    <a href="<?php echo e(url('resultadosElectorales/28')); ?>">
                    <span class="icon"><i class="fa fa-list-alt"></i></span>
                    <span>Resultados Electorales</span></a>
                </a>
            </li>
            
            <li style="margin: 0 2px;">
                <a href="#sidebar-dashboard" data-toggle="collapse" data-parent="#sidebar">
                    <a href="<?php echo e(url('resumen_plantillas/')); ?>">
                    <span class="icon"><i class="fa fa-list-alt"></i></span>
            ...
            <li style="margin: 0 2px;">
                <a href="#sidebar-dashboard" data-toggle="collapse" data-parent="#sidebar">
                    <a href="<?php echo e(url('rentabilidad/')); ?>">
                    <span class="icon"><i class="fa fa-list-alt"></i></span>
                    <span>Rentabilidad</span></a>
                </a>
            </li>
            <li style="margin: 0 2px;">
                <a href="#sidebar-dashboard" data-toggle="collapse" data-parent="#sidebar">
                    <a href="<?php echo e(url('casillas/zonametropolitana')); ?>">
                    <span class="icon"><i class="fa fa-list-alt"></i></span>
                    <span>Zona Metropolitana</span></a>
                </a>
            </li>
            <li style="margin: 0 2px;">
                <a href="#sidebar-dashboard" data-toggle="collapse" data-parent="#sidebar">
                    <a href="<?php echo e(url('casillas/top10')); ?>">
                    <span class="icon"><i class="fa fa-list-alt"></i></span>
                    <span>Principales 10 municipios</span></a>
                </a>
            </li>
